...
ALARM_PATH := vendor/chitang/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/chitang/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/chitang/prebuilt/common/media/audio/ringtones
